...
download_and_verify https://github.com/phracker/MacOSX-SDKs/releases/download/10.15/MacOSX10.13.sdk.tar.xz a3a077385205039a7c6f9e2c98ecdf2a720b2a819da715e03e0630c75782c1e4
tar xf $DEPENDENCIES/MacOSX10.13.sdk.tar.xz -C $DEPENDENCIES
sudo rm -rf /Applications/Xcode_12.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
sudo ln -s $DEPENDENCIES/MacOSX10.13.sdk /Applications/Xcode_12.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
sudo chown runner /Applications/Xcode_12.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
# replace MinimumSDKVersion
LANG=C LC_CTYPE=C LC_ALL=C sudo sed -i .orig -E 's/[0-9][0-9].[0-9][0-9]/10.13/' /Applications/Xcode_12.2.app/Contents/Developer/Platforms/MacOSX.platform/Info.plist
#sudo ln -s $DEPENDENCIES/MacOSX10.13.sdk /Library/Developer/CommandLineTools/SDKs/MacOSX/MacOSX10.13.sdk
# sudo ln -sf /Applications/Xcode_12.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk /Applications/Xcode_12.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
# ls -l /Applications/Xcode_12.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/

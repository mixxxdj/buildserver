...
"%CMAKEDIR%\cmake" .. -G %COMPILERPROJECT% %ADDITIONAL_SETTINGS% -DBUILD_TEST_APPLICATION=OFF -DCMAKE_PREFIX_PATH=%ROOT_DIR%\Qt-%QT_VERSION%\lib\cmake -DCMAKE_INSTALL_PREFIX=%ROOT_DIR% -DCMAKE_INSTALL_INCLUDEDIR=%INCLUDE_DIR%
IF ERRORLEVEL 1 (
    SET VALRETURN=1
    goto END
)

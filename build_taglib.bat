...
"%CMAKEDIR%\cmake" ../ -G %COMPILERPROJECT% -DENABLE_STATIC=%STATIC_LIBS% -DCMAKE_SUPPRESS_REGENERATION=1 -DCMAKE_USE_RELATIVE_PATHS=1 -DZLIB_INCLUDE_DIR=%INCLUDE_DIR% -DZLIB_LIBRARY=%LIB_DIR%\%ZLIBNAME%
IF ERRORLEVEL 1 (
    SET VALRETURN=1
	goto END
)

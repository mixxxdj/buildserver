...
//
// built-in (default) GUID for the VHPD1394 interface
//
// IMPORTANT:
// Don't use this GUID for your own (custom) applications. Generate a new one
// that is private to you, put it in the VHPD1394 INF file, and use it in 
// your application. Refer to the VHPD1394 manual for further instructions.
// The tool guidgen.exe from the Microsoft Platform SDK or Visual Studio 
// development platform is used to create a private GUID.
//
#define VHPD_IID_STR      "{65C9EA1C-B39E-11d3-A276-0080C8945707}"
#define VHPD_IID_STR_W   L"{65C9EA1C-B39E-11d3-A276-0080C8945707}"
#define VHPD_IID  { 0x65c9ea1c, 0xb39e, 0x11d3, { 0xa2, 0x76, 0x0, 0x80, 0xc8, 0x94, 0x57, 0x7 } }

// {59C5385B-28D6-4ec0-B544-E25453102798}
///////////////////////////////////////////////////////////////////
// Status Codes
///////////////////////////////////////////////////////////////////
